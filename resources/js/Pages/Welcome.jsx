    ...
    return (
        <Layout jumbotron={true}>
            ...
            <div
                ...
                style={{ backgroundImage: item ? `url(${item.image_fullpath})` : '' }}
            >
                <div className='max-w-7xl mx-auto p-2 sm:p-4 flex justify-center sm:justify-start items-center z-20'>
                    <h1 className='text-3xl font-bold w-4/5 sm:w-1/2'>This is a sample application that is built with Laravel, Inertia, React and Vite. It's just a SPA, but it works on VPS with SSR.</h1>
                </div>
            </div>
            <div className='max-w-7xl mx-auto p-4 sm:p-0 mt-4 sm:mt-16'>
                <div className='sm:flex sm:-mx-2'>
                    <div className='sm:w-1/2 sm:px-4 mb-8 sm:mb-0'>
                        ...
                        <p>Inertia is a JavaScript library to connect backends and frontends like Laravel and React. You can implement React components insted of Blade templates in Laravel. Also, you can use SSR on VPS. </p>
                    ...
                    <div className='sm:w-1/2 sm:px-4'>
                        ...
                        <table className='text-left w-full table-fixed break-all'>
                            <tbody>
                                <tr>
                                    <th className='w-1/6 align-top'>GitHub</th>
                                ...
                                <tr>
                                    <th className='align-top'>Laravel</th>
                                ...
                                <tr>
                                    <th className='align-top'>Inertia</th>
