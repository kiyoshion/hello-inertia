...
export default function AppHead({ title = '', desc = '', image = '' }) {
  ...
  return (
    <Head>
      ...
      {/* Twitter */}
      <meta head-key='twitterSite' name='twitter:site' content={import.meta.env.OGP_TWITTER_SITE} />
      <meta head-key='twitterCard' name='twitter:card' content='summary_large_image' />
      <meta head-key='twitterDomain' name='twitter:domain' content={import.meta.env.OGP_TWITTER_DOMAIN} />
